...
OUT_A="$BRANDING_DIR/lucky-verified-ai-bg-a.png"
OUT_B="$BRANDING_DIR/lucky-verified-ai-bg-b.png"
STATUS_FILE="$BRANDING_DIR/lucky-verified-ai-status.md"
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/lucky-ai-bg-XXXXXX")"
...
PROMPT_A='abstract plum and midnight gradient waves, cinematic soft glow, premium branding background, no text, no logos, no characters, clean center composition'
PROMPT_B='dark violet and neon pink atmospheric gradient with subtle layered ribbons, minimal noise, strong negative space for headline, no text, no logos'
...
- Fallback: \
Use deterministic ImageMagick backgrounds from \`generate-verified-banner-v4.sh\`.
STATUS
