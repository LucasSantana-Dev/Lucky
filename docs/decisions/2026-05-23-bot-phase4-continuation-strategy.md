...
- **Status:** Accepted
- **Owner:** Lucas Santana
- **Supersedes:** `docs/decisions/2026-05-23-bot-phase4-execution-strategy.md` (staged-pilot ADR — pilot goal achieved by independent execution)
- **Related:** `docs/decisions/2026-05-23-bot-test-reduction-phase4-replacement-strategy.md`, issues #956, #959–962, #964, #966
