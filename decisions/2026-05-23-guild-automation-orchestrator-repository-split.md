...
This ADR codifies the split that the existing `GuildAutomationExecutionService` refactor plan intended (referenced in `decisions/2026-05-19-guild-automation-module-executors.md`) but which was not structurally separated.
