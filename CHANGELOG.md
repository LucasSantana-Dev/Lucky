...
- **presence rotation templates**: `BOT_PRESENCE_ACTIVITIES` now customizes non-music presence rotation while preserving the default rotation when unset and keeping now-playing presence overrides intact.
