...
* **bot:** move artist discography helper out of commands scan path ([#2319](https://github.com/LucasSantana-Dev/Lucky/issues/2319)) ([39226be](https://github.com/LucasSantana-Dev/Lucky/commit/39226becb1446af54785cbfba47044f48b700b24))
...
* **bot:** auto-disable channel purge configs after repeated failures ([#2275](https://github.com/LucasSantana-Dev/Lucky/issues/2275)) ([c469fc6](https://github.com/LucasSantana-Dev/Lucky/commit/c469fc6f9509d8bf94e4ed5aab92f1d493e0f77b))
...
* **backend:** close guild settings/autoplay access-control gap ([#2244](https://github.com/LucasSantana-Dev/Lucky/issues/2244)) ([befb8e6](https://github.com/LucasSantana-Dev/Lucky/commit/befb8e63857314720484ee5483315f9287d57a0c))
* **backend:** close music playback/queue/state access-control gap ([#2245](https://github.com/LucasSantana-Dev/Lucky/issues/2245)) ([f466216](https://github.com/LucasSantana-Dev/Lucky/commit/f4662162cad8e119ea82383b4c98db590bf1a830))
...
* **bot:** stop autoplay snapshot resurrection after /stop ([#2242](https://github.com/LucasSantana-Dev/Lucky/issues/2242)) ([85bb951](https://github.com/LucasSantana-Dev/Lucky/commit/85bb951c6523143b9fc3970c82e6f060ae781604))
...
* **ci:** run the scripts/ tests, and fix the one that was red ([#2122](https://github.com/LucasSantana-Dev/Lucky/issues/2122)) ([37d516c](https://github.com/LucasSantana-Dev/Lucky/commit/37d516c228afcf73206adc7561ce004f6208d100))
...
* **frontend:** point support link at our own support server ([#2092](https://github.com/LucasSantana-Dev/Lucky/issues/2092)) ([0e39fb0](https://github.com/LucasSantana-Dev/Lucky/commit/0e39fb048e3f205616e425f032a66342e92925d2))
* **nginx:** route /webhooks/ to backend so top.gg vote calls land ([#2089](https://github.com/LucasSantana-Dev/Lucky/issues/2089)) ([5b084b2](https://github.com/LucasSantana-Dev/Lucky/commit/5b084b2e51c8abf8e31b6e17b76177a6f5dc8fa4))

## [2.39.7](https://github.com/LucasSantana-Dev/Lucky/compare/v2.39.6...v2.39.7) (2026-08-23)


### Bug Fixes

* **shared:** write the log level as a parseable token ([#2081](https://github.com/LucasSantana-Dev/Lucky/issues/2081)) ([c66edc3](https://github.com/LucasSantana-Dev/Lucky/commit/c66edc31af08b05e3956ffbde4393ddf1349c796))
...
* **bot:** guard voice/session mutations with stop/suppress flags ([#1998](https://github.com/LucasSantana-Dev/Lucky/issues/1998)) ([23eaba2](https://github.com/LucasSantana-Dev/Lucky/commit/23eaba2e3d5e8d5a435d635fd15fbb9e6d3be003))
* **ci:** clear stale audit-gate entries and bump fixed advisories ([#1942](https://github.com/LucasSantana-Dev/Lucky/issues/1942)) ([adf710b](https://github.com/LucasSantana-Dev/Lucky/commit/adf710bc5bece62d815912f3929ee55bcc9b872e))
* **ci:** clear stale audit-gate entries and bump fixed advisories ([#1960](https://github.com/LucasSantana-Dev/Lucky/issues/1960)) ([2c17c99](https://github.com/LucasSantana-Dev/Lucky/commit/2c17c995be9fb248594dcd0b8a3cf9cb9fb07101))

## [2.39.1](https://github.com/LucasSantana-Dev/Lucky/compare/v2.39.0...v2.39.1) (2026-07-30)


### Bug Fixes

* **music:** stop the attachment extractor swallowing text searches ([#1930](https://github.com/LucasSantana-Dev/Lucky/issues/1930)) ([879c69f](https://github.com/LucasSantana-Dev/Lucky/commit/879c69fc99b4c644f36fe9eb04a04a501a8b63cf))
